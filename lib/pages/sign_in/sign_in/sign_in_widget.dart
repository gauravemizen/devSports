                              ...
                              child: Row(
                                ...
                                children: [
                                  Expanded(
                                    child: Stack(
                                      children: [
                                        if (_model.selectedLoginType != 'email')
                                          InkWell(
                                  ...
                                  Expanded(
                                    child: Stack(
                                      children: [
                                        if (_model.selectedLoginType == 'phone')
                                          Container(
                                            decoration: BoxDecoration(
                                              gradient: LinearGradient(
                                                colors: [
                        ...
                        Align(
                          ...
                          child: Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                0.0, 30.0, 0.0, 0.0),
                            child: Text(
                              _model.selectedLoginType == 'email'
                                  ? 'Email Address'
                                  : 'Phone Number',
                              style: FlutterFlowTheme.of(context)
                                  .labelMedium
                              ...
                              child: Text(
                                ...
                                style: FlutterFlowTheme.of(context)
                                    ...
                                    .override(
                                      ...
                                      color:
                                          FlutterFlowTheme.of(context).skyBlue,
                                      letterSpacing: 0.0,
                                      fontWeight: FlutterFlowTheme.of(context)
                                          .titleSmall
                                          .fontWeight,
